...
-Tag bot to search from youtube and get link .
EX. @miko_music_bot <song name> then bot will show song info through inline mode just click on it , bot will send link then reply that link with /play and enjoy .
